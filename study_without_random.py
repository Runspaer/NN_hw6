...
def select_elites(states_batch, actions_batch, rewards_batch, percentile = 90):
    '''
    ...
    for epoch in range(1000):
        ...
        for i in range(N_AGENTS):
            ...
            while True:
                ...
                # Выбираем вариант предсказанный моделью
...
if __name__ == '__main__':
    '''
        Обучение модели (ответ выбирается как np.argmax(proba))
